...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        example: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI1NTBlODQwMC1lMjliLTQxZDQtYTcxNi00NDY2NTU0NDAwMDAiLCJ0eXBlIjoicmVmcmVzaCIsImlhdCI6MTYzOTU4MjgwMCwiZXhwIjoxNjQwMTg3NjAwfQ.signature_here',
        format: 'jwt',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
